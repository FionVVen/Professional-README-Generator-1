...
const promptUser = () => {
  return inquirer.prompt([
      ...
      },
    {
      type: 'input',
      name: 'contributing',
      message: 'If you would like other developers to contribute to your project, you will want to add guidelines for how to do so. Please input the contribution guidelines of your project.',
    },
    {
      type: 'input',
      name: 'tests',
      message: 'Want to go an extra mile? Write tests for your project. Then provide examples on how to run them. Please enter test instructions here.',
    },
    {
      type: 'list',
      name: 'license',
